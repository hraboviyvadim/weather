...
/***/ function(module, exports, __webpack_require__) {
	...
	var _geolocation = __webpack_require__(4);
	
	var _getData = __webpack_require__(5);
	
	var _weather = __webpack_require__(3);
	
	var _forecast = __webpack_require__(6);
	...
	var app = function app() {
	    ...
	    //const forecastTemp
	    var tempChart = void 0;
	    var tempForecastChart = function tempForecastChart() {
	        Highcharts.setOptions({
	            colors: ['#19b88a', '#4a4a4a', '#18966E', '#f5f6f7', '#fff', '#ff7373']
	        });
	
	        var data = (0, _forecast.tempForecastArr)();
	        var startTime = JSON.parse(window.localStorage.forecast).list[0].dt;
	            ...
	            plotOptions: {
	                series: {
	                    fillColor: {
	                        ...
	                        stops: [[0, Highcharts.Color(Highcharts.getOptions().colors[0]).setOpacity(0.5).get('rgba')], [1, Highcharts.Color(Highcharts.getOptions().colors[0]).setOpacity(0).get('rgba')]]
	                    }
	                }
	            },
	            series: [{
	    ...
	    var localWeather = function localWeather() {
	        if ((0, _geolocation.isGeolocation)()) {
	            helpers.showPreloader();
	
	            if (window.localStorage.coords) {
	                var coords = (0, _geolocation.getSavedCoords)();
	                (0, _getData.getWeatherByCoors)(coords.latitude, coords.longitude).then(function (data) {
	                    helpers.showResultsBox();
	                    (0, _weather.renderWeatherContent)(data);
	                    window.localStorage.weather = JSON.stringify(data);
	                }).catch(function (error) {
	                    helpers.showNotification(_config2.default.errorLocationMsg.className, error.text);
	                    helpers.hidePreloader();
	                    helpers.hideResultsBox();
	                });
	
	                (0, _getData.getForecastByCoors)(coords.latitude, coords.longitude).then(function (data) {
	                    window.localStorage.forecast = JSON.stringify(data);
	                    (0, _forecast.renderForecastContent)(data);
	                    if (typeof tempChart == 'undefined') {
	                        tempForecastChart();
	                    } else {
	                        tempChart.series[0].setData((0, _forecast.tempForecastArr)(), true);
	                    }
	                }).catch(function (error) {
	                    helpers.showNotification(_config2.default.errorLocationMsg.className, error.text);
	                    helpers.hidePreloader();
	                ...
	                (0, _geolocation.getLocation)(function (response) {
	
	                    var latitude = response.coords.latitude;
	                    var longitude = response.coords.longitude;
	
	                    (0, _geolocation.saveCoords)(latitude, longitude);
	
	                    (0, _getData.getWeatherByCoors)(latitude, longitude).then(function (data) {
	                        helpers.showResultsBox();
	                        (0, _weather.renderWeatherContent)(data);
	                        window.localStorage.weather = JSON.stringify(data);
	                    }).catch(function (error) {
	                    ...
	                    (0, _getData.getForecastByCoors)(latitude, longitude).then(function (data) {
	                        window.localStorage.forecast = JSON.stringify(data);
	                        (0, _forecast.renderForecastContent)(data);
	                        tempForecastChart();
	                    }).catch(function (error) {
	                ...
	                }, _geolocation.catchLocationError);
	            }
	        } else {
	            helpers.showNotification(_config2.default.notSupportedMsg.className, _config2.default.notSupportedMsg.text);
	        }
	    };
	    localWeather();
	    ...
	    var cityWeather = function cityWeather(city, country) {
	        var _this = this;
	
	        helpers.showPreloader();
	        helpers.hideNotification();
	        (0, _getData.getWeatherByCityName)(city, country).then(function (data) {
	            helpers.showResultsBox();
	            (0, _weather.renderWeatherContent)(data);
	            hideMap();
	            _this.value = '';
	            ...
	            helpers.showNotification(_config2.default.errorCityMsg.className, _config2.default.errorCityMsg.text);
	            helpers.hidePreloader();
	            helpers.hideResultsBox();
	        });
	
	        (0, _getData.getForecastByCityName)(city, country).then(function (data) {
	            window.localStorage.forecast = JSON.stringify(data);
	            (0, _forecast.renderForecastContent)(data);
	            if (typeof tempChart == 'undefined') {
	                tempForecastChart();
	            ...
	            helpers.showNotification(_config2.default.errorCityMsg.className, error.message);
	        });
	    };
	    ...
	    var coordsWeather = function coordsWeather(lat, long) {
	        var _this2 = this;
	
	        helpers.showPreloader();
	        helpers.hideNotification();
	        (0, _getData.getWeatherByCoors)(lat, long).then(function (data) {
	            helpers.showResultsBox();
	            (0, _weather.renderWeatherContent)(data);
	            hideMap();
	            _this2.value = '';
	            ...
	            helpers.showNotification(_config2.default.errorCoordsMsg.className, _config2.default.errorCoordsMsg.text);
	            helpers.hidePreloader();
	            helpers.hideResultsBox();
	        });
	
	        (0, _getData.getForecastByCoors)(lat, long).then(function (data) {
	            window.localStorage.forecast = JSON.stringify(data);
	            (0, _forecast.renderForecastContent)(JSON.parse(window.localStorage.forecast));
	            if (typeof tempChart == 'undefined') {
	                tempForecastChart();
	            } else {
	                tempChart.series[0].setData((0, _forecast.tempForecastArr)(), true);
	    ...
	    (function () {
	        var formCoords = document.getElementById('formCoords');
	    ...
	    // change units format
	    _config2.default.unitsSelect.addEventListener('change', function () {
	        // save new unots format to localStorage
	        window.localStorage.units = this.value;
	
	        // get current weather data
	        var d = JSON.parse(window.localStorage.weather);
	        // get current forecast data
	        var f = JSON.parse(window.localStorage.forecast);
	        ...
	        (0, _weather.renderWeatherContent)(JSON.parse(window.localStorage.weather));
	        (0, _forecast.renderForecastContent)(JSON.parse(window.localStorage.forecast));
	    ...
	    var forecastDays = document.querySelectorAll('.forecast__item');
	    forecastDays.forEach(function (item) {
	        item.addEventListener('click', function () {
	            forecastDays.forEach(function (day) {
	                day.classList.remove('active');
	            });
	            this.classList.add('active');
	            var counter = JSON.parse(window.localStorage.forecast).list.length - 1;
	            var start = this.getAttribute('starttime');
	            var end = JSON.parse(window.localStorage.forecast).list[counter].dt;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.convertDate = exports.setUnitsFormatSelect = exports.transformSpeed = exports.transformTemp = exports.transformUnits = exports.getUnits = exports.selectChange = exports.showResultsBox = exports.hideResultsBox = exports.hidePreloader = exports.showPreloader = exports.windDirection = exports.weekday = exports.currentFullDate = exports.hideNotification = exports.showNotification = exports.closest = undefined;
	...
	var showNotification = exports.showNotification = function showNotification(className, message) {
	    var container = document.getElementById('notification');
	    container.innerHTML = '<p></p>';
	
	    var inner = container.querySelector('p');
	...
	var currentFullDate = exports.currentFullDate = function currentFullDate() {
	    var now = new Date();
	
	    return now.getHours() + ':' + now.getMinutes() + ', ' + _config2.default.months[now.getMonth()] + ', ' + now.getDate() + ', ' + now.getFullYear();
	};
	
	// get day name
	var weekday = exports.weekday = function weekday(timestamp) {
	    var n = new Date(timestamp).getDay();
	    return _config2.default.days[n];
	};
	
	// transform wind meteorological degrees into humanfriendly string, e.g. 191.504 => 'South-southwest'
	var windDirection = exports.windDirection = function windDirection(deg) {
	    return _config2.default.windDirections[Math.floor(deg / 22.5 + 0.5) % 16];
	};
	
	// show preloader
	var showPreloader = exports.showPreloader = function showPreloader() {
	...
	// hide results block
	var hideResultsBox = exports.hideResultsBox = function hideResultsBox() {
	    var target = document.getElementById('dataBox');
	    target.style.display = 'none';
	};
	
	// show results block
	var showResultsBox = exports.showResultsBox = function showResultsBox() {
	    var target = document.getElementById('dataBox');
	    target.style.display = 'block';
	};
	
	// custom select
	var selectChange = exports.selectChange = function selectChange(el) {
	
	    el.forEach(function (item) {
	        var select = item.querySelector('select');
	        var valueBox = item.querySelector('.select__value');
	...
	var transformUnits = exports.transformUnits = function transformUnits(format) {
	    var units = {};
	    if (format == 'metric') {
	        units.tempUnits = '\xB0C';
	        units.speedUnits = 'm/s';
	    } else if (format == 'imperial') {
	        units.tempUnits = '\xB0F';
	...
	// transform units
	var transformTemp = exports.transformTemp = function transformTemp(val, format) {
	    if (format == 'metric') {
	...
	var transformSpeed = exports.transformSpeed = function transformSpeed(val, format) {
	    if (format == 'metric') {
	...
	var setUnitsFormatSelect = exports.setUnitsFormatSelect = function setUnitsFormatSelect() {
	    var select = _config2.default.unitsSelect;
	    var valueBox = select.closest('.js-select').querySelector('.select__value');
	...
	var convertDate = exports.convertDate = function convertDate(timestamp) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.renderWeatherContent = undefined;
	...
	var renderWeatherContent = exports.renderWeatherContent = function renderWeatherContent(data) {
	
	    var tempUnit = (0, _helpers.transformUnits)((0, _helpers.getUnits)()).tempUnits;
	    var tempValue = Math.floor(data.main.temp);
	
	    var speedUnit = (0, _helpers.transformUnits)((0, _helpers.getUnits)()).speedUnits;
	    var speedValue = data.wind.speed;
	
	    _config2.default.weather.cityBox.textContent = data.name;
	    _config2.default.weather.descrBox.textContent = data.weather[0].description;
	    _config2.default.weather.tempBox.textContent = tempValue + ' ' + tempUnit;
	    _config2.default.weather.countryBox.textContent = data.sys.country;
	    _config2.default.weather.timeBox.textContent = (0, _helpers.currentFullDate)();
	    _config2.default.weather.windSpeed.textContent = speedValue + ' ' + speedUnit;
	    _config2.default.weather.windDir.textContent = (0, _helpers.windDirection)(data.wind.deg);
	    _config2.default.weather.pressureBox.textContent = Math.floor(+data.main.pressure * 0.750061561303);
	    _config2.default.weather.humidityBox.textContent = data.main.humidity;
	    _config2.default.weather.iconBox.innerHTML = '<img src="http://openweathermap.org/img/w/' + data.weather[0].icon + '.png">';
	
	    (0, _helpers.hidePreloader)();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getSavedCoords = exports.saveCoords = exports.getLocation = exports.catchLocationError = exports.isGeolocation = undefined;
	...
	var isGeolocation = exports.isGeolocation = function isGeolocation() {
	    return navigator.geolocation ? true : false;
	};
	
	var catchLocationError = exports.catchLocationError = function catchLocationError(error) {
	    switch (error.code) {
	        case error.PERMISSION_DENIED:
	            (0, _helpers.hidePreloader)();
	            (0, _helpers.showNotification)(_config2.default.notAllowedMsg.className, _config2.default.notAllowedMsg.text);
	            break;
	        case error.POSITION_UNAVAILABLE:
	        case error.TIMEOUT:
	        case error.UNKNOWN_ERROR:
	            (0, _helpers.hidePreloader)();
	            (0, _helpers.showNotification)(_config2.default.errorLocationMsg.className, error.message);
	            break;
	    }
	};
	
	var getLocation = exports.getLocation = function getLocation(success, error) {
	    navigator.geolocation.getCurrentPosition(success, error);
	};
	
	var saveCoords = exports.saveCoords = function saveCoords(lat, long) {
	    var coords = {};
	    coords.latitude = lat;
	...
	var getSavedCoords = exports.getSavedCoords = function getSavedCoords() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getForecastByCityName = exports.getWeatherByCityName = exports.getForecastByCoors = exports.getWeatherByCoors = undefined;
	...
	var getWeatherByCoors = exports.getWeatherByCoors = function getWeatherByCoors(lat, long) {
	
	    var units = (0, _helpers.getUnits)();
	    return fetch('http://api.openweathermap.org/data/2.5/weather?lat=' + lat + '&lon=' + long + '&units=' + units + '&APPID=' + _config2.default.openWeatherApi).then(function (response) {
	        return response.json();
	    });
	};
	
	// get forecast from Open Weather Map API by coors
	var getForecastByCoors = exports.getForecastByCoors = function getForecastByCoors(lat, long) {
	
	    var units = (0, _helpers.getUnits)();
	    return fetch('http://api.openweathermap.org/data/2.5/forecast?lat=' + lat + '&lon=' + long + '&units=' + units + '&APPID=' + _config2.default.openWeatherApi).then(function (response) {
	        return response.json();
	    });
	};
	
	// get current weather from Open Weather Map API by city name
	var getWeatherByCityName = exports.getWeatherByCityName = function getWeatherByCityName(city, country) {
	
	    var units = (0, _helpers.getUnits)();
	
	    // check if user specified country as a second parameter
	    if (typeof country == 'undefined') {
	        return fetch('http://api.openweathermap.org/data/2.5/weather?q=' + city + '&units=' + units + '&APPID=' + _config2.default.openWeatherApi).then(function (response) {
	            return response.json();
	        });
	    }
	    return fetch('http://api.openweathermap.org/data/2.5/weather?q=' + city + ',' + country + '&units=' + units + '&APPID=' + _config2.default.openWeatherApi).then(function (response) {
	        return response.json();
	    });
	};
	
	// get current weather from Open Weather Map API by city name
	var getForecastByCityName = exports.getForecastByCityName = function getForecastByCityName(city, country) {
	
	    var units = (0, _helpers.getUnits)();
	
	    // check if user specified country as a second parameter
	    if (typeof country == 'undefined') {
	        return fetch('http://api.openweathermap.org/data/2.5/forecast?q=' + city + '&units=' + units + '&APPID=' + _config2.default.openWeatherApi).then(function (response) {
	            return response.json();
	        });
	    }
	    return fetch('http://api.openweathermap.org/data/2.5/forecast?q=' + city + ',' + country + '&units=' + units + '&APPID=' + _config2.default.openWeatherApi).then(function (response) {
	        return response.json();
	    });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.renderForecastContent = exports.dailyForecast = exports.tempForecastArr = undefined;
	
	var _helpers = __webpack_require__(2);
	
	// get array of temperature values
	var tempForecastArr = exports.tempForecastArr = function tempForecastArr() {
	    var arr = JSON.parse(window.localStorage.forecast).list;
	    var tempArr = [];
	...
	var dailyForecast = exports.dailyForecast = function dailyForecast() {
	    var arr = JSON.parse(window.localStorage.forecast).list;
	    ...
	    var day1 = new Date(todayYear, todayMonth, todayDate + 1).getDate();
	    var day2 = new Date(todayYear, todayMonth, todayDate + 2).getDate();
	    var day3 = new Date(todayYear, todayMonth, todayDate + 3).getDate();
	    var day4 = new Date(todayYear, todayMonth, todayDate + 4).getDate();
	    ...
	    arr.forEach(function (item) {
	        var date = (0, _helpers.convertDate)(item.dt).getUTCDate();
	        switch (date) {
	            case todayDate:
	    ...
	    var getDailyTempArr = function getDailyTempArr(arr) {
	        var result = [];
	        arr.forEach(function (item) {
	    ...
	    var getDailyIcon = function getDailyIcon(arr) {
	        var n = Math.floor(arr.length / 2);
	        return arr[n].weather[0].icon;
	    };
	    var getWeekday = function getWeekday(arr) {
	        return (0, _helpers.weekday)(arr[0].dt * 1000);
	    };
	...
	var renderForecastContent = exports.renderForecastContent = function renderForecastContent(data) {
	    ...
	    var item = document.querySelectorAll('.forecast__item');
	    var maxBox = document.querySelectorAll('.forecast__maxtemp');
	    var minBox = document.querySelectorAll('.forecast__mintemp');
	    var iconBox = document.querySelectorAll('.forecast__icon');
	    var dayBox = document.querySelectorAll('.forecast__day');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initMap = exports.initMap = function initMap() {
	    var defaultCoords = void 0;
	    var mapBox = document.getElementById('map');
	    if (window.localStorage.coords) {
	        defaultCoords = (0, _geolocation.getSavedCoords)();
	    } else {
	        defaultCoords = {
	            latitude: 50.456191,
	            longitude: 30.575257
	    ...
	    google.maps.event.addListener(map, 'click', function (event) {
	        ...
	        var formCoords = document.getElementById('formCoords');
	        var input = formCoords.querySelector('input');
...
/***/ function(module, exports) {
	...
	exports.default = function () {
	    ...
	    this.open = function (link) {
	        var target = document.querySelector('[data-name=' + link + ']');
	        var targetIn = target.querySelector('.modal__in');
	    ...
	    this.close = function () {
	        target.forEach(function (modal) {
	            var targetIn = modal.querySelector('.modal__in');
